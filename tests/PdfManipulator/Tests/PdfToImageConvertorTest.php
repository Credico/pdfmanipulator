...
class PdfToImageConvertorTest extends \PHPUnit_Framework_TestCase
{
	...
	public function ConvertsToJpg()
	{
		...
		$results = $convertor->convert(file_get_contents(__DIR__.'/fixture/reminder_color.pdf'));
		...
		$this->assertFileEquals(__DIR__.'/fixture/expected_reminder_color.jpg', __DIR__.'/fixture/converted.jpg', 'The converted jpg differs from the expected jpg');
